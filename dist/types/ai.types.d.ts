...
export interface AiClassOptions<TOutput = unknown> extends Omit<AiInvocationOptions<unknown, TOutput>, "abortSignal" | "inputSchema"> {
}
export interface AiChatOptions<TInput = unknown, TOutput = string> extends AiInvocationOptions<TInput, TOutput> {
}
export interface AiCompletionOptions<TInput = unknown, TOutput = string> extends AiInvocationOptions<TInput, TOutput> {
}
export interface AiEmbedOptions<TInput = unknown, TOutput = number[]> extends AiInvocationOptions<TInput, TOutput> {
}
export interface AiAgentOptions<TInput = unknown, TOutput = unknown> extends AiInvocationOptions<TInput, TOutput> {
}
...
export interface ResolvedAiInvocationOptions<TOutput = unknown> extends AiInvocationOptions<unknown, TOutput> {
    stream: boolean;
    autoRun: boolean;
}
